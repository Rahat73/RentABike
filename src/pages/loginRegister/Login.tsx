          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-500">
                Discover the ultimate freedom on two wheels. Our motorcycle
                rental service offers a wide range of bikes to suit every
                rider's needs. Explore new horizons and create unforgettable
                memories.
              </p>
            </div>
            ...
            <div className="p-10 border-2 border-dashed">
              ...
              <p className="mt-4 text-center text-gray-500 text-sm">
                ...
                <Link to="/register" className="underline text-amber-600">
                  Register
                </Link>
              </p>
            </div>
